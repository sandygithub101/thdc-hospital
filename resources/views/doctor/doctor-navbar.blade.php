  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-white active" aria-current="page" href="#"> <i class="fa fa-home"></i> Home</a>
        </li> 
        @guest
        ...
        @else
        <li class="nav-item">
          <a class="nav-link text-white" href="{{ url('doctor/doctor-dashboard') }}"><i class="fab fa-dashcube"></i> Dashboard</a>
        </li>  
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="{{ route('doctor-signout') }}"><i class="fa fa-sign-out-alt"></i> Logout</a>
        </li>
        @endguest
      </ul> 
    </div>
